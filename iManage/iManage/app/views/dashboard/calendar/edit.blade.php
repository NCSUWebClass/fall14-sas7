...
@section('head')
<title>iManage app - Edit Event</title>
@stop
@section('content')
              ...
              <div class="row-fluid">
                    ...
                    <div class="control-group">
                      ...
                      <div class="controls">
                        <div class="task_select">
                            ...
                            <input value="" type="text" name="category" id="category" tabindex="1" data-required="true"  data-show-errors="false" />
                            @else
                            <input value="{{ $event[0]['category'] }}" type="text" name="category" id="category" tabindex="1" data-required="true"  data-show-errors="false" />
                            @endif
                        </div>
                      </div>
                    </div>
                ...
                <div class="span5 add_proj_right add-proj-form">
                  <div class="control-group col">
                    <label class="control-label" for="passwordinput">People:<span class="tooltipster-icon" title="Assign event to User, Kindly provide your name, if you want to specify yourself.">(?)</span></label>
                    <div class="controls">

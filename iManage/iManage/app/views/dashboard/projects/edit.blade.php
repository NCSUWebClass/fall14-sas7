...
@section('head')
<title>iManage app - Edit Project</title>
@stop
@section('content')
            ...
            <div class="row-fluid">
              ...
              <div class="span5 add_proj_right add-proj-form">
                <div class="control-group col">
                  <label class="control-label" for="passwordinput">Owner:<span class="tooltipster-icon" title="The person who is responsible for this project">(?)</span></label>
                  <div class="controls">
